...
#Adadelta for doc...
def adadelta_doc(lr, tparams, grads, x, mask, y, sent_lengths, num_doc, max_llen, mask_l, cost):
    """
    An adaptive learning rate optimizer
    ...
    f_grad_shared = theano.function([x, mask, y, sent_lengths, num_doc, max_llen, mask_l], cost, updates=zgup + rg2up,name='adadelta_f_grad_shared',on_unused_input='ignore')
